$(document).ready(function(){   
    ...
    function attachFluidLikeBox(){
        ...
        var fbml = '<fb:like-box href="https://www.facebook.com/USArmyFortCarson" width="WIDTH" show_faces="false" stream="true" header="false" show_border="false" scrolling="yes"></fb:like-box>';//$('#likeBoxTemplate').text().toString();
