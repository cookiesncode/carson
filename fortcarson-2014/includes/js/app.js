...
// MISCELLANEOUS ///////////////////////////// 
	...
	// todo: get rid of fittext
	$("#fittext").fitText(1.5, { minFontSize: '18px', maxFontSize: '30px'});
	
// DISCLAIMER MODAL ///////////////////////////// 
// todo: figure out how to close this modal without affecting the others.
	if ($.cookie('disclaimer') !== 'checked' ) {
		$('#disclaimer').foundation('reveal', 'open', {
				url: '/fortcarson-2014/disclaimer.html',
				error: function (data) {
...
// LEADERS SLIDER ///////////////////////////// 
// todo: Fix bug in chrome for transitions not working
	if ($.fn.elastislide) {
